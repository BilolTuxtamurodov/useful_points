...
import 'package:useful_points/data/storage/app/locals/error_words.dart';
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (url.startsWith('http://') || url.startsWith('https://')) {
                    ...
                    showSnackBar(title: ErrorWords.formatError.tr, isError: true, duration: const Duration(seconds: 5));
                  }
                  Navigator.pop(context);
                },
                child: Container(
